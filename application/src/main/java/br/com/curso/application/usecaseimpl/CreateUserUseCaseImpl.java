...
public class CreateUserUseCaseImpl implements CreateUserUseCase {
    ...
    public CreateUserUseCaseImpl(TaxNumberAvailableUseCase taxNumberAvailableUseCase, EmailAvailableUseCase emailAvailableUseCase, CreateUserGateway createUserGatewaye) {
